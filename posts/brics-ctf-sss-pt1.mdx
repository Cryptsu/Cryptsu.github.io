...
> 
> There's a very cool algorithm that allows us to do **FFT** in $O(N\log{N})$**-ish** without us needing to have $2^s$-th root of unity **:-)**, but rather $N$-th root of unity $\not\equiv 1$ for any $N$ dividing $p - 1$!
<br/>
