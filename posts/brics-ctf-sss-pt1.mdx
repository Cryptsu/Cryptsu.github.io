...
> 
> However, there's a very cool modification to **FFT** that allows us to do **FFT** in $O(N\log{N})$**-ish** without us needing to have $2^s$-th root of unity **:-)**, but with just $N$-th roots of unity and $N$ outputs of $f(x)$!
<br/>
